...
function main(params, callback){
  ...
  const label = custom.label || '';  //  UnaBell Label e.g. excellent, goodjob
  ...
  const result = { deviceId, data, messageType, dataType, decodedDataType, macAddress, wifiRSSI0, wifiRSSI, dataType2, decodedDataType2, batteryLevel0, batteryLevel, label };
